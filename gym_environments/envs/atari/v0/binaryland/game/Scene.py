...
class Scene:
    ...
    def get_state(self):
        ...
        c1i, c1j = int(self.character_1.y // settings.TILE_SIZE), int(self.character_1.x // settings.TILE_SIZE)
        c2i, c2j = int(self.character_2.y // settings.TILE_SIZE), int(self.character_2.x // settings.TILE_SIZE)
        gi, gj = int(self.goal.y // settings.TILE_SIZE), int(self.goal.x // settings.TILE_SIZE)
    ...
    def check_win(self):
        return self.character_1.collides_with(self.goal) and self.character_2.collides_with(self.goal)
