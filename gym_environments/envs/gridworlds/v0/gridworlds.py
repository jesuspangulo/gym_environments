...
class RobotBatteryEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        self.P = {0: {1: [(1, 2, 0.0, False)], 2: [(1, 1, 0.0, False)]}, \
                  1: {0: [(1, 0, 0.0, False)], 1: [(1, 3, 0.0, False)]}, \
                  2: {1: [(1, 4, 0.0, False)], 2: [(1, 3, 0.0, False)], 3: [(1, 0, 0.0, False)]}, \
                  3: {0: [(1, 2, 0.0, False)], 1: [(1, 5, 1.0, True)], 3: [(1, 1, 0.0, False)]}, \
                  4: {2: [(1, 5, 1.0, True)], 3: [(1, 2, 0.0, False)]}, \
                  5: {0: [(1, 5, 0.0, True)]}}
        self.reset()
